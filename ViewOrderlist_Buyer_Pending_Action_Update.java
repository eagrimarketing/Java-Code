 ...
 */
public class ViewOrderlist_Buyer_Pending_Action_Update extends AppCompatActivity implements View.OnClickListener, HttpResponse, AdapterView.OnItemSelectedListener {
    ...
    String Order_Status_Code_Buyer_Rejected = "3BB";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> os = ArrayAdapter.createFromResource(this,R.array.Buyer_accept_reject_delivery,R.layout.support_simple_spinner_dropdown_item);
    ...
    public void onClick(View v) {
        ...
        if (i==3) {
            ...
            if (status_entered.contains(Order_Status_Option_Buyer_Reject))
            {
                Temp_Status = Order_Status_Code_Buyer_Rejected;
            }
    ...
    public void getResponse(String serverResponse, String responseType) {
        ...
        try {
            ...
            if (s.equals("Success")) {
                Intent i1 = new Intent(this,ViewOrderlist_Buyer_Pending_Action.class);
